...
sudo docker build -t elasticpostgresql:docker_magnolia_alpine_v1 -f docker_magnolia_alpine/Dockerfile docker_magnolia_alpine/.
...
sudo docker tag elasticpostgresql:docker_magnolia_alpine_v1 localhost:5000/elasticpostgresql:docker_magnolia_alpine_v1
sudo docker push localhost:5000/elasticpostgresql:docker_magnolia_alpine_v1
